...
var Presets = map[int]Preset{
	...
	43626: {
		...
		ChainConfig: ChainConfig{
			Preset: 43626,
			L1Contracts: L1Contracts{
				AddressManager:              common.HexToAddress("0xBB70347a3b1B938d6c637855587E5571218A4A6c"),
				SystemConfigProxy:           common.HexToAddress("0x6905944bDD1D7B5C933Ca27CC3Df78c005E68463"),
				OptimismPortalProxy:         common.HexToAddress("0xB1d87d619ee6aE9A1689928a08F77DCB625DcA31"),
				L2OutputOracleProxy:         common.HexToAddress("0x32469270C6A6EA69EE2E81125E99429F8947Bc0B"),
				L1CrossDomainMessengerProxy: common.HexToAddress("0x1a8a261F2b084D39213611E0A9cEf9E93F97AF10"),
				L1StandardBridgeProxy:       common.HexToAddress("0x2eaC078a2711412D7a17F228C6409684884a1758"),
				L1ERC721BridgeProxy:         common.HexToAddress("0x86E2FecFa51cCfBeD133486c82cDa713b1cf67bA"),
				DisputeGameFactoryProxy:     common.HexToAddress("0x71391e2c5E5C25699619D05DF1489a0b18f458A4"),
			},
			L1StartingHeight:    5370868,
			L1ConfirmationDepth: 10,
			L2ConfirmationDepth: 75,
		},
	},
